public void uponContact(int power, int vert, int hor) //ratio = y/x
{
...
public boolean includes(int x, int y) //DW About this
{
   ...
   if(x >= x1 && x <= x2 && y >= bottomLeft.getY() && y <= topRight.getY())
      return true;
   return false;
}